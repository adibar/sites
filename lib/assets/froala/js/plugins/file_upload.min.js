...
! function(a) {
    a.Editable.commands = a.extend(a.Editable.commands, {
        ...
        this.restoreSelectionByMarkers(), this.focus(), this.options.useFileName || "" === this.text() || (b = this.text()), this.insertHTML('<a class="fr-file" href="' + this.sanitizeURL(a) + '">' + b + "</a>"), this.hide(), this.hideFileLoader(), this.focus(), this.triggerEvent("fileUploaded", [b, a, c])
    }
}(jQuery);