$(document).ready(function(){
  $('body').on('click','.fancyble', function() {
  	...
  	for (i=0; i<els.length; i++) {
  		fancyarr.push( { href: $(els[i]).data('image'), title: "Image Number " + i, } );
  	}
  ...
  $.each( $('.slider_container'), function() {
    load_jssor( $(this).attr('id') );
  });
...
function update_overflow() {
  ...
  $("#horizontal-nav").overflowNavs({
    "more"    : "", 
    //"parent"  : "#horizontal-nav",
    // "parent" : "#bs-example-navbar-collapse-1",
    "parent" : ".wrapper-addons",
...
function load_jssor(id) {
  ...
  if ( $('#'+id).find('.jssor-slides').length > 0 ) {
