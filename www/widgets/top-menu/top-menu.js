function PDG_top_menu(path, data) {
  ...
  this.default_controllers = {
    'root': {
      ...
      // 'brand-image': { 'type':'image-selector',  }
      ...
      //'brand-width-2': { 'type':'slider', 'val':40, 'range':[100,500], 'units':'px', "cb":"set_css", 'el':[ ['#xxxx', 'width'] ], }, 
